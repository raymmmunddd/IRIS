...
export default function CaseChatPage() {
  ...
  if (activeThread) {
    return (
      <div className="flex h-screen flex-col bg-background text-foreground">
        <header className="flex-shrink-0 border-b border-border bg-[var(--sidebar-bg)] px-4 pb-4 pt-4 text-[var(--sidebar-foreground)] shadow-sm">
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="mx-auto w-full max-w-md space-y-3 px-4 pb-8 pt-4">
