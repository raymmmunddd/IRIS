...
export default function ResidentAccountPage() {
  ...
  useEffect(() => {
    ...
    const t = setInterval(
      () => setCooldown((v) => (v <= 1 ? (clearInterval(t), 0) : v - 1)),
      1000
    );
      ...
      <div className="flex min-w-0 flex-1 flex-col">
        ...
        <main className="flex-1 overflow-y-auto p-4 sm:p-6 lg:p-8">
          <div className="hidden lg:block">
            <PageHeader
              title="My Account"
              description="Manage your resident profile, contact details, and security preferences."
          ...
          <div className="mx-auto w-full max-w-md lg:max-w-6xl">
            <div className="mb-4 flex rounded-xl border border-border bg-card p-1 gap-1 lg:mb-6">
            ...
            {tab === "profile" && (
              <div className="space-y-4 lg:grid lg:grid-cols-[1.1fr_0.9fr] lg:gap-6 lg:space-y-0">
