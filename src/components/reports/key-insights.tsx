    ...
    <div className="flex h-full flex-col rounded-xl border border-border bg-card p-6 shadow-sm">
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
        <div className="flex flex-col gap-1 border-l-4 border-blue-500 pl-4 py-1">
            ...
            <span className="text-xl font-bold text-blue-600">Purok 3</span>
            <span className="text-xs text-muted-foreground">156 cases this period</span>
        </div>
        <div className="flex flex-col gap-1 border-l-4 border-green-500 pl-4 py-1">
            ...
            <span className="text-xl font-bold text-green-600">Public Disturbance</span>
            <span className="text-xs text-muted-foreground">312 cases reported</span>
        </div>
